...
class AppConstants {
  ...
  // BLE UUIDs
  static const String bleServiceControlUUID =
      '0000180A-0000-1000-8000-00805F9B34FB';
  static const String bleServiceNotificationUUID =
      '0000180B-0000-1000-8000-00805F9B34FB';
  static const String bleServiceDataUUID =
      '0000180C-0000-1000-8000-00805F9B34FB';

  // BLE Characteristics
  static const String bleCharCommandUUID =
      '00002A00-0000-1000-8000-00805F9B34FB';
  static const String bleCharStatusUUID =
      '00002A01-0000-1000-8000-00805F9B34FB';
  static const String bleCharSMSAlertUUID =
      '00002A10-0000-1000-8000-00805F9B34FB';
  static const String bleCharCallAlertUUID =
      '00002A11-0000-1000-8000-00805F9B34FB';
  static const String bleCharAppNotificationUUID =
      '00002A12-0000-1000-8000-00805F9B34FB';
  static const String bleCharBulkTransferUUID =
  ...
  static const String keyReconnectAttempts = 'reconnect_attempts';
  static const String keyBatteryMode =
      'battery_mode'; // 'performance' or 'battery_saver'

  // Security Settings Keys
  static const String keyEncryptionEnabled = 'encryption_enabled';
  static const String keyLastContactSync = 'last_contact_sync';

  // Default Values
  static const int defaultConnectionTimeout = 30;
  static const int defaultReconnectAttempts = 5;
  static const String defaultBatteryMode = 'performance';

  // Notification Channels (Android)
  static const String notificationChannelId = 'bridge_phone_channel';
  static const String notificationChannelName = 'Bridger';
  static const String notificationChannelDescription =
      'Notifications from Bridger';

  // Foreground Service
  static const int foregroundServiceNotificationId = 1001;
  static const String foregroundServiceTitle = 'Bridger Active';
  static const String foregroundServiceMessage =
      'Maintaining connection with paired device';
